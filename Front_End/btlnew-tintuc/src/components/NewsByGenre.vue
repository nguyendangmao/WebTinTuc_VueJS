          ...
          <div class="row">
            <div class="col-12">
              <div class="section-title">
                <h4 class="m-0 text-uppercase font-weight-bold">Genre</h4>
              </div>
            </div>
            <div
              class="col-lg-6"
...
export default {
  ...
  created() {
    let idNhomTin = this.$route.params.id;
    this.getbaiviets(idNhomTin);
  },
  updated() {
    //Check xem đó là nhóm tin hay thể loại
